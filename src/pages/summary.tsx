  ...
  return (
    <SlideFade in>
      <main className="flex flex-col h-[100vh] justify-between overflow-x-hidden z-10">
        <React.Fragment>
          <div className="bg-myRed1 w-full h-full absolute -z-40 transition-colors"></div>
          <div className="bg-lightGray rounded-b-[5rem] w-full h-1/3 absolute -z-30 transition-colors"></div>
        </React.Fragment>
        <Nav swap />

        <div className="h-[90%] flex flex-col sm:flex-row justify-center sm:mt-36 w-full absolute overflow-hidden">
          <div className="z-10 mx-[10%] md:mx-auto h-[60vh] md:w-[24rem] bg-white rounded-xl shadow-md shadow-myRed1 flex flex-col gap-4 pt-10 text-center">
        ...
        <div className="h-[90%] flex flex-col sm:flex-row justify-center sm:mt-36 w-[75vw] absolute overflow-hidden -rotate-12">
          <div className="bg-lightGray z-10 mx-[10%] md:mx-auto h-[60vh] md:w-[24rem] rounded-xl shadow-md border-gray  shadow-myRed2 flex flex-col gap-4 pt-10 text-center">
            <p className="text-center w-full font-regularBold text-2xl md:text-3xl underline"></p>
            <p className="text-center w-full font-regularBold text-xl md:text-2xl"></p>
          </div>
        </div>
        <div className="bg-myRed1 rounded-3xl mx-[12%] sm:mx-auto mb-12 pt-4 max-w-[28rem] border border-white relative text-white">
          ...
          {loading ? (
            ...
            <CiPaperplane className="absolute right-4 top-5" size={20} />
          )}
        </div>
      </main>
    </SlideFade>
